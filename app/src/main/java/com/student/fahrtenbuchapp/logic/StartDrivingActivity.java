            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if(!isChecked)
                {
                    if(tvStartPosition.getText() != null) {
                        ...
                        builder.setView(layoutInflater.inflate(R.layout.dialog_layout_poi, null))
    ...
    public void onClick(View v) {
        ...
        switch (v.getId())
        {
            case R.id.buttonStart:
                ...
                else if(stringKiloStart.trim().length() == 0)
                {
                ...
                else
                {
                    ...
                    myBuilder.setView(inflater.inflate(R.layout.dialog_layout_drive, null))
                            .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                @Override
                                public void onClick(DialogInterface dialog, int which) {

                                    startActivity(new Intent(StartDrivingActivity.this, MyPopUp.class));
            ...
            case R.id.buttonStop:
                ...
                else
                {
                    ...
                    builder.setView(inflater.inflate(R.layout.dialog_stop_drive, null))
                            .setPositiveButton("Ja", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
